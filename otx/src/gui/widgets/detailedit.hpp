...
public:
    ...
    /* RCS_options:Array to handle the options selected in the Role Credential Screen, to be passed to Cambrian
      index 0:   RCS_currentNymIndex  // Role Credential Screen stores the current Nym Selected by default is the first nym on db
      index 1:  RCS_NymIndex; // RCS stores the last Nym Created in order to store,switch or delete in Cambrian. If the value is -1 no operation is required
      index 2: RCS_ActionRequest; // RCS 0 Cancel
                                          1 One Nym was created
                                          2 Request switch operation 3 Delete operation*/
