...
#include <../src/gui/widgets/pageacct_nym.hpp>
    ...
    ui(new Ui::MTPageAcct_Nym)
{
    ...
    // -----------------------------------------------
    connect(this, SIGNAL(SetDefaultNym(QString, QString)), OTX::It(), SLOT(setDefaultNym(QString,QString)));
}


void MTPageAcct_Nym::on_pushButtonSelect_clicked()
{
    QString qstr_default_id = OTX::It()->get_default_nym_id();
    // -------------------------------------------
