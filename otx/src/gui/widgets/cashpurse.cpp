...
#include <../src/gui/widgets/editdetails.hpp>
#include <../src/gui/widgets/dlggetamount.hpp>
#include <../src/gui/widgets/overridecursor.hpp>

#include <../src/gui/ui/dlgexportedtopass.hpp>
#include <../src/gui/ui/dlgexportedcash.hpp>
#include <../src/gui/ui/dlgexportcash.hpp>
...
void MTCashPurse::on_pushButtonWithdraw_clicked()
{
    ...
    if (!bSent)
    {
        ...
        const int64_t lUsageCredits  = OTX::HasUsageCredits(this, str_server, str_nym);
...
void MTCashPurse::on_pushButtonDeposit_clicked()
{
    ...
    if (reply == QMessageBox::Yes)
    {
        ...
        if (!bSent)
        {
            const int64_t lUsageCredits = OTX::HasUsageCredits(this, str_acct_server, str_acct_nym);
