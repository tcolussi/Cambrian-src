...
#include <../src/gui/widgets/cashpurse.hpp>
#include <../src/gui/widgets/home.hpp>
#include <../src/gui/widgets/wizardaddaccount.hpp>
...
//      ui->lineEditID  ->setText(strID);
        ...
        FavorLeftSideForIDs();
        // -----------------------------------------------------------------------
        QString qstr_default_acct_id = OTX::It()->get_default_account_id();
...
void MTAccountDetails::CloseButtonClicked()
{
    this->close();
}
...
void MTAccountDetails::AddButtonClicked()
{
    ...
    if (QDialog::Accepted == theWizard.exec())
    {
        ...
        if (!bIsRegiseredAtServer)
        {
            ...
            if (1 != nSuccess)
            {
                OTX::HasUsageCredits(this, qstrServerID, qstrNymID);
                return;
            }
        }
        // --------------------------
        ...
        {
            const int64_t lUsageCredits = OTX::HasUsageCredits(this, qstrServerID, qstrNymID);
