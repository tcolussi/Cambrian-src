...
#include <../src/gui/widgets/wizardnewoffer.hpp>
...
*/
        ...
        if (!bPlacedOffer)
        {
            const int64_t lUsageCredits = OTX::HasUsageCredits(this, str_server_id, str_nym_id);
...
{
    QString qstr_default_id = OTX::It()->get_default_server_id();
    // -------------------------------------------
