...
#include <../src/gui/widgets/pageacct_asset.hpp>
    ...
    ui(new Ui::MTPageAcct_Asset)
{
    ...
    // -----------------------------------------------
    connect(this, SIGNAL(SetDefaultAsset(QString, QString)), OTX::It(), SLOT(setDefaultAsset(QString,QString)));
}
...
{
    // --------------------------------------------------
    QString     qstr_default_id = OTX::It()->get_default_asset_id();
    // -------------------------------------------
