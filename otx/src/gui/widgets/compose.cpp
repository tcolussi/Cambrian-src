                            ...
                            QString viaServer, QString viaTransport, int viaMethodID)
{
    ...
    if (0 == viaTransport.compare("otserver"))
    {
        ...
        if (1 != nReturnVal)
        {
            ...
            OTX::HasUsageCredits(this, str_serverId, str_fromNymId);
...
//    }
    ...
    // ability to send the Bitmessage, since otherwise OTX will be useless
    ...
    if (!OTAPI_Wrap::It()->IsNym_RegisteredAtServer(sender_id, server_id))
    {
        if (bAsk)
        {
            ...
            if (reply == QMessageBox::Yes)
            {
                ...
                if (1 != nReturnVal)
                {
                    OTX::HasUsageCredits(this, server_id, sender_id);
                    return false;
                }
            }
            else
    ...
    ui(new Ui::MTCompose)
{
    ...
    connect(this, SIGNAL(ShowNym(QString)),     OTX::It(), SLOT(mc_show_nym_slot(QString)));
