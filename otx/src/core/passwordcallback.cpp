...
#include <../src/gui/ui/dlgpassword.hpp>
...
//    MTDlgPassword * pDlg = new MTDlgPassword(NULL, theOutput);
    MTDlgPassword * pDlg = new MTDlgPassword(OTX::It(), theOutput);
...
//    MTDlgPasswordConfirm * pDlg = new MTDlgPasswordConfirm(NULL, theOutput);
    MTDlgPasswordConfirm * pDlg = new MTDlgPasswordConfirm(OTX::It(), theOutput);
