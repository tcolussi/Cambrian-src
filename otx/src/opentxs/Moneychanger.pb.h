...
#ifndef PROTOBUF_OTX_2eproto__INCLUDED
#define PROTOBUF_OTX_2eproto__INCLUDED
...
void  protobuf_AddDesc_OTX_2eproto();
void protobuf_AssignDesc_OTX_2eproto();
void protobuf_ShutdownFile_OTX_2eproto();
...
class ServerInfo_InternalPB : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_OTX_2eproto();
  friend void protobuf_AssignDesc_OTX_2eproto();
  friend void protobuf_ShutdownFile_OTX_2eproto();
...
inline void ServerInfo_InternalPB::set_allocated_server_id(::std::string* server_id) {
  if (server_id_ != &::google::protobuf::internal::kEmptyString) {
    delete server_id_;
  }
  if (server_id) {
...
inline void ContactAcct_InternalPB::set_allocated_server_id(::std::string* server_id) {
  if (server_id_ != &::google::protobuf::internal::kEmptyString) {
    delete server_id_;
  }
  if (server_id) {
...
inline void ContactAcct_InternalPB::set_allocated_asset_type_id(::std::string* asset_type_id) {
  if (asset_type_id_ != &::google::protobuf::internal::kEmptyString) {
...
#endif  // PROTOBUF_OTX_2eproto__INCLUDED
