...
#define d_szApplicationVersion			"0.0.6.1"
#define d_szwApplicationVersion		   L"0.0.6.1"
...
class IEvent;
	...
	class CEventGroupMessageSent;
	class CEventGroupMessageReceived;
