...
public:
	...
	void ** PrgpvGetElementsStopMax(OUT void *** pppvElementStop, int cElementsMax) const;
	void ** PrgpvGetElementsStopLast(OUT void *** pppvElementStop, int cElementsLastMax) const;
