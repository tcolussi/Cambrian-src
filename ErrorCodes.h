...
enum ESeverity	// Severity/importance of a string
	...
	eSeverityErrorWarning		= 7,		// Display an error to user.  This is typically an unsual code path taken by the program worth reporting to the user as a warning, typically from invalid data.
